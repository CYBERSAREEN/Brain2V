...
| `/obs-verify-brain2v` | after touching app/dashboard/n8n/Graphify wiring; or "test everything end-to-end" | auto-offer after infra changes; runs `scripts/verify-e2e.sh` and loops real fixes until clean or blocked on something only the user can provide |
